        ...
        <div className="experience__chinese">
          ...
          <div className="experience__chinese">
            ...
            <article className="experience__details">
              <BsPatchCheckFill className="experience__details-icon" />
              <div>
                <h4>WGC(World Gas Conference) Supporter</h4>
                <small className="text-light">Experienced</small>
              </div>
            </article>
            <article className="experience__details">
              <BsPatchCheckFill className="experience__details-icon" />
              <div>
                <h4>International Youth Center Translator</h4>
                <small className="text-light">Experienced</small>
              </div>
            </article>
            <article className="experience__details">
            ...
            <article className="experience__details">
              <BsPatchCheckFill className="experience__details-icon" />
              <div>
                <h4>Korea-China Association Youth representative</h4>
                <small className="text-light">Experienced</small>
              </div>
            </article>
            <article className="experience__details">
              <BsPatchCheckFill className="experience__details-icon" />
              <div>
                <h4>Legal Interpreter (Korea-Chinese)</h4>
                <small className="text-light">Experienced</small>
              </div>
            </article>
          </div>
